...
return new class extends Migration {
    ...
    public function up(): void
    {
        ...
        (240.28,230.00,70.00, 0.00,0.00,0.00,-40.75,-1000.00,0.00,0.00,'Año de la pandemia\, con reunirnos en la plaza y poco mas ha sido suficiente :)',2020,2023,current_timestamp,current_timestamp),
        ...
        (3266.14,490.00,95.00, 92.00,350.00,-100.80,-72.10,-2800.00,-850.00,-1100.00,'Los adolescentes no tenian ninguna actividad\, para el año que viene organizarles algo',2017,1720,current_timestamp,current_timestamp),
        ...
        (3448.69,580.00,110.00, 90.00,450.00,-98.04,-60.80,-2290.00,-1250.00,-1100.00,'Han faltado vasos de plastico\, encargar 200 mas de cada tipo para el año que viene',2013,2225,current_timestamp,current_timestamp),
        (3832.12,480.00,115.00, 78.00,500.00,-107.10,-75.10,-2700.00,-950.00,-1400.00,'Hay que repintar las tablas para el torneo de las chapas',2012,2326,current_timestamp,current_timestamp),
        ...
        (3067.91,565.00,105.00, 88.00,500.00,-118.25,-65.45,-2100.00,-1000.00,-1100.00,'Hay que hacer cuadrantes de reparticion de tareas',2010,1922 ,current_timestamp,current_timestamp);
        ";
